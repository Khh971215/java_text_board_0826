...
public class App {
    ...
    void actionUserArticleDelete(Rq rq) {
...
//        Article article = articles.get(id - 1);
    ...
    void actionUserArticleModify(Rq rq) {
        Map<String, String> params = rq.getParams();
        int id = 0;
    ...
    void actionUserArticleDetail(Rq rq) {
        Map<String, String> params = rq.getParams();
        int id = 0;
    ...
    void actionUserArticleList(Rq rq) {
        Map<String, String> params = rq.getParams();
